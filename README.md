...
- [Chakra-UI](https://chakra-ui.com/docs/) interface styling (feel free to replace with your favorite UI)
...
5. Follow the Prompt
6. Create a new private Github repository. Please invite @wallstead, @derek-cs, @3103ski, and @chrismochinski
7. Initialize and push to Github `git init` `git origin add your-repo-url` `git push origin main`
